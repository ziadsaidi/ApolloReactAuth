...
/**
 * __useDeleteAllUsersMutation__
 *
 * To run a mutation, you first call `useDeleteAllUsersMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useDeleteAllUsersMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [deleteAllUsersMutation, { data, loading, error }] = useDeleteAllUsersMutation({
 *   variables: {
 *   },
 * });
 */
